                ...
                <div class="relative max-w-md">
                    ...
                    <ul class="mt-10 space-y-5">
                        <li class="flex items-center gap-4">
                            ...
                            <span class="font-medium">{{ __('shop.buy_one_click') }}</span>
                        </li>
                        <li class="flex items-center gap-4">
                            <span class="flex items-center justify-center w-11 h-11 rounded-xl bg-white/15">
                            ...
                            <span class="font-medium">{{ __('shop.delivery_nationwide') }}</span>
                        </li>
                        <li class="flex items-center gap-4">
                            <span class="flex items-center justify-center w-11 h-11 rounded-xl bg-white/15">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                            </span>
                            <span class="font-medium">{{ __('shop.return_policy') }}</span>
                        </li>
                    </ul>
                </div>
