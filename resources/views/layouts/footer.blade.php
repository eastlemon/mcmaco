<footer class="bg-gray-800 text-gray-300 mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            {{-- Каталог --}}
            <div>
                <h4 class="text-white font-medium text-sm mb-3">Каталог</h4>
            ...
            {{-- Контакты --}}
            <div>
                <h4 class="text-white font-medium text-sm mb-3">Контакты</h4>
                <ul class="space-y-2 text-sm">
        ...
        <div class="border-t border-gray-700 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-4 text-xs text-gray-500">
                ...
                <span class="bg-gray-700 px-2 py-1 rounded text-gray-300">При получении</span>
            </div>
        </div>
    </div>
</footer>