<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="mt-8 space-y-5">
        ...
        <label class="flex items-center gap-2.5 cursor-pointer select-none">
            ...
            <span class="text-sm text-gray-500">Запомнить меня</span>
        </label>
    ...
    <p class="mt-8 text-sm text-center text-gray-500">
        Нет аккаунта?
        <a href="{{ route('register') }}" class="font-semibold text-amber-600 hover:text-amber-700 transition">Зарегистрируйтесь</a>
    </p>
</x-guest-layout>